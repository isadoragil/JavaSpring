...
public class Principal {
    ...
    private final String API_KEY = "&apikey=4c19ce34";
...
//            }
        ...
        List<DadosEpisodio> dadosEpisodios = temporadas.stream()
                ...
                .collect(Collectors.toList()); // .toList() gera a lista imutável
        dadosEpisodios.forEach(System.out::println);

//        System.out.println("/nTop 10 episódios");
...
//                .forEach(System.out::println);
        ...
        System.out.println("Pesquise um episódio por título:");
...
//                .findFirst();
        ...
        System.out.println("Melhor episódio: " + String.format("%.2f", est.getMax()));
        System.out.println("Pior episódio: " + String.format("%.2f", est.getMin()));
